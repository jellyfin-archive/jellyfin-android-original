...
function hideSearchMenu(){if($('.viewMenuSearch').is(':visible')){require(["jquery","velocity"],function($,Velocity){$('.btnCloseSearch').hide();var elem=$('.viewMenuSearch').css({left:'0'})[0];Velocity.animate(elem,{"left":"100%"},{complete:function(){$('.viewMenuSearch').visible(false);}});});}}
