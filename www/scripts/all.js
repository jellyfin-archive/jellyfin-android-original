...
window.appMode='cordova';window.dashboardVersion='3.0.5700.27796';
...
return appStorage.getItem('enableFullScreen')=='true';},syncPath:function(val){if(val!=null){update('syncPath',val);}
