...
window.appMode='cordova';window.dashboardVersion='3.0.5715.38715';
...
$.mobile.changePage(url,options);},showLoadingMsg:function(){console.log('showLoadingMsg');var elem=document.querySelector('.docspinner');if(elem){elem.active=true;}else{elem=document.createElement("paper-spinner");elem.classList.add('docspinner');document.body.appendChild(elem);elem.active=true;}},hideLoadingMsg:function(){console.log('hideLoadingMsg');var elem=document.querySelector('.docspinner');if(elem){elem.active=false;setTimeout(function(){elem.active=false;},100);}},getModalLoadingMsg:function(){var elem=$('.modalLoading');if(!elem.length){elem=$('<div class="modalLoading" style="display:none;"></div>').appendTo(document.body);}
