...
function renderThemeSongs(page,items){if(items.length){$('#themeSongsCollapsible',page).show();var html=LibraryBrowser.getListViewHtml({items:items,smallIcon:true});$('#themeSongsContent',page).html(html);}else{$('#themeSongsCollapsible',page).hide();}}
