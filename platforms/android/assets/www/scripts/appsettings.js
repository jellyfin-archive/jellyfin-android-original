(function(window,store){function update(key,val){store.setItem(key,val);Events.trigger(AppSettings,'settingupdated',[key]);}
...
return store.getItem('syncPath');}};})(window,window.appStorage);