...
requireCss.load=function(cssId,req,load,config){cssId=cssId.replace('components/requirecss','css');var url=cssId+'.css';var packageName='';if(url.indexOf('theme#')!=-1){url=url.replace('theme#','');packageName='theme';}
